#GerEstoque que funciona isoladamente
        ...
        while novoiten == "sim":
          ...
          if resp == 'sim':
            ...
            if indice_item != -1:
              ...
              print(
                f"O item {cod_item_excluir} não foi encontrado no estoque.")

            novoiten = str(
              input("Deseja excluir um novo item? (sim/não): ")).lower()
          elif resp == 'não':
            novoiten = 'não'
          else:
